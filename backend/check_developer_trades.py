"""
Check recent developer trades to see if transfers succeeded.
"""
import sys
import os
...
def check_developer_trades():
    ...
    try:
        ...
        print(f"Found {len(trades)} developer trades in the last hour:\n")
        ...
        if failed_trades:
            ...
            print("Run: python backend/retroactive_transfer.py to retry transfers")
        else:
