...
export default function Footer() {
  return (
    <footer className="relative bg-background-deep border-t border-border/50">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-text-muted text-sm mb-6 max-w-xs">
              The Infrastructure for Nature Recovery. Building the future of 
            ...
            <div className="flex gap-4">
              <a
                href="#twitter"
                className="w-10 h-10 rounded-lg bg-background-surface flex items-center justify-center text-text-muted hover:text-accent-primary hover:bg-accent-primary/10 transition-colors"
              >
        ...
        <div className="mt-16 pt-8 border-t border-border/50 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-text-muted">
            © 2026 NEMX Ltd. All rights reserved.
          </p>
